...
=== "lpspec"
    ...
    lookups:
      ...
      line_from: {over: [line, bus], key: line, coverage: masked, description: "the bus a line leaves, absent where the end is open"}
      line_to: {over: [line, bus], key: line, coverage: masked, description: "the bus a line arrives at, absent where the end is open"}
