...
One rung of [the PyPSA corpus](https://math-spec.readthedocs.io/en/latest/examples/pypsa_quadratic/#rung-10--quadratic-costs): the file `pypsa.yaml` projected onto what this network builds, attached to that network, and held to what PyPSA solves it to.
