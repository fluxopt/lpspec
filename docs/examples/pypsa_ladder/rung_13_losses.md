...
One rung of [the PyPSA corpus](https://math-spec.readthedocs.io/en/latest/examples/pypsa_losses/#rung-13--transmission-losses): the file `pypsa.yaml` projected onto what this network builds, attached to that network, and held to what PyPSA solves it to.
