...
One rung of [the PyPSA corpus](https://math-spec.readthedocs.io/en/latest/examples/pypsa/#rung-16): the file `pypsa.yaml` projected onto what this network builds, attached to that network, and held to what PyPSA solves it to.
...
=== "lpspec"
    ...
    with lps.solve('differential/pypsa/rungs/rung_16_link_delay.yaml', sources) as solution:
