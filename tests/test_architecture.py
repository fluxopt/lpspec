...
PUBLIC_API = {
    ...
    'carry it': {'SolveArtifact', 'SweepArtifact', 'load_artifact', 'load_result', 'load_runs'},
...
def test_the_sources_argument_is_one_type_at_every_door():
    ...
    doors = {
        ...
        'solve': lpspec.solve,
        'write': lpspec.write,
        'SolveArtifact': lpspec.SolveArtifact.__init__,
        'SweepArtifact': lpspec.SweepArtifact.__init__,
