...
| `operators/` | one minimal model per operator in [the operator reference](https://mathspec.readthedocs.io/en/latest/reference/language/operators/), which is where the math on that page comes from |
