...
- docs: the site follows the reader's light or dark setting in its own violet colour, and footnotes render ([#1767](https://github.com/fluxopt/specsolve/pull/1767))
