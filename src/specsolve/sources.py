...
:mod:`specsolve.curves`, which :func:`tidy_sources` calls on the way through.
"""
...
from specsolve.curves import derive_curve_sources, validate_curve_extent, validate_piecewise_data
...
def attachable(program: Program) -> dict[str, ParameterDeclaration | DimensionDeclaration | RelationDeclaration]:
    ...
    :func:`~specsolve.curves.derive_curve_sources` fills it, so a caller neither
